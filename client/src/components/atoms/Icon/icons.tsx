...
export const icons = {
  ...
  tooth: (props: SVGProps) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 4c-3.5 0-5.5 2.5-5.5 5.5 0 2.5 1 5 1.5 7s1 3.5 4 3.5 3.5-1.5 4-3.5 1.5-4.5 1.5-7C17.5 6.5 15.5 4 12 4z" />
    </svg>
  ),
...
} as const satisfies Record<string, (props: SVGProps) => React.ReactElement>;
